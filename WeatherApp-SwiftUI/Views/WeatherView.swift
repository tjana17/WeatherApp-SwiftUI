                        ...
                        ForEach(0..<forecast.list.count) {index in
                            ...
                            if today == true {
                                TodayCardView(imageTxt: "https://openweathermap.org/img/wn/\(forecast.list[index].weather[0].icon)@2x.png",
                                              ...
                                              timeTxt: "\(OpenWeatherAPI().epochTime(Double(forecast.list[index].dt)))")
                            }
                            
                        }
                        ////https://openweathermap.org/img/wn/\(forecast.list[index].weather[0].icon)@2x.png
//                        TodayCardView(imageTxt: "☁️", degreeTxt: "\(forecast.list[0].main.feelsLike.roundDouble())°", timeTxt: "6 AM")
//                        TodayCardView(imageTxt: "🌥️", degreeTxt: "\(forecast.list[1].main.feelsLike.roundDouble())°", timeTxt: "8 AM")
//                        TodayCardView(imageTxt: "⛅️", degreeTxt: "\(forecast.list[2].main.feelsLike.roundDouble())°", timeTxt: "10 AM")
//                        TodayCardView(imageTxt: "🌤️", degreeTxt: "\(forecast.list[3].main.feelsLike.roundDouble())°", timeTxt: "12 PM")
//                        TodayCardView(imageTxt: "☁️", degreeTxt: "\(forecast.list[4].main.feelsLike.roundDouble())°", timeTxt: "2 PM")
//                        TodayCardView(imageTxt: "🌥️", degreeTxt: "\(forecast.list[5].main.feelsLike.roundDouble())°", timeTxt: "5 PM")
//                        TodayCardView(imageTxt: "⛅️", degreeTxt: "\(forecast.list[6].main.feelsLike.roundDouble())°", timeTxt: "7 PM")
//                        TodayCardView(imageTxt: "🌤️", degreeTxt: "\(forecast.list[7].main.feelsLike.roundDouble())°", timeTxt: "10 PM")
                    }
                }
                Spacer()
                    .padding(.top)
